    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) { 
                ...
                $var = '<br />';
                $content = '';
                $content .= $this->storeManager->getWebsite($item['website_id'])->getName() . " (" . $this->storeManager->getStore($item['website_id'])->getName() . ")";
                $item['website_id'] = html_entity_decode($content);
            }
        }
